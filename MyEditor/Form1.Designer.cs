namespace MyEditor
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.openFileDialog.Filter = "Rich Text File|*.rtf|Plain Text File|*.txt|All files|*.*";
            // 
            // saveFileDialog
            // 
            this.saveFileDialog.DefaultExt = "rtf";
            this.saveFileDialog.Filter = "Rich Text File|*.rtf|Plain Text File|*.txt|All files|*.*";
            // 
