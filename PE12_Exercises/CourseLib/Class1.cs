...
namespace CourseLib
{
    public class Class1
    {
        ...
        public class Courses
        {
            ...
            //Removes course code if there is one
    ...
    //Schedule has fields for start and end time DateTimes and a list to hold days of the week
    ...
    public class Course
    {
        ...
        //Constructor, takes strings for coursecode and description, initializes fields.
